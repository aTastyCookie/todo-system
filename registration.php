...
{ 
    ...
    if ($total > 0)
    {
       echo "fail_email"; // returns fail_email when email address already exists in db
        ...
        $message = 
        "Hello $username , \n
Thank you for registering to Todo App. Using Todo App is going to change the way you organize your life. \n
To get started, simply login in to the app. \n
        
        The Todo App Team
        ";
        
        	mail($email, "Welcome to Todo App", $message,
            "From: \"Todo App\" <auto-reply@todoapp.com>\r\n" .
