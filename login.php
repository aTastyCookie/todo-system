...
<body>
	<h1 class="u-title">Login to the App</h1>
	<p class="p-forgot">Please login to the App with your username and password.</p>
	...
	<div id="login-form">
	    ...
	    <form action="login.php" method="post" name="logForm" id="logForm" >
		    ...
		    <div style="margin-left:42px;float: left;">
	            <a href="index.php" class="block-text" style="float:left;margin-top: 2em;width: auto;">New to ToDo App? </a><span class="divider"> | </span> <a href="forgot.php" class="block-text" style="float:left;margin-top: 2em;width: auto;"> Forgot password?</a>
	        </div>
